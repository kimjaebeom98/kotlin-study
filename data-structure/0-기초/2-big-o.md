...
그래프 스케일 때문에 O(1) / O(log n) / O(n)은 서로 구분이 잘 안 되니, 실제 값을 표로 보면 명확하다.
...
| 15 | 1 | 3.9 | 15 | 58.6 | 225 |
| 20 | 1 | 4.3 | 20 | 86.4 | 400 |

n=20 기준으로 O(1)은 1, O(n)은 20인데 O(n²)은 400이다. 격차가 눈에 바로 들어온다.
